...
<div id="page-header" class="site-page-header">
  <div class="container pr">
      ...
      <div class="col-lg-12">
        <div class="page-header-wrapper" data-aos="fade-in">
          ...
          if (!empty($page_description)) {
          	...
          	echo sprintf('<p class="banner__description">%1$s</p>', esc_html__("Our ability to provide strategic insights is strengthened by the collective intelligence of our people working across our global network.", "ifchor"));
          ...
          if (is_array($banner_button) && sizeof($banner_button) > 0):
          	...
          	if ($button_url_url != ""): ?>
          <a target="<?php echo esc_attr($button_url_target); ?>" href="<?php echo esc_url($button_url_url); ?>" class="ifchor_btn btn-outline-light header-btn">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" class="bottom-icon" width="30.995" height="21.112" viewBox="0 0 30.995 21.112">
      <g id="Group_8" data-name="Group 8" transform="translate(-35.006 0.001) rotate(90)">
        <g id="Group_6" data-name="Group 6" transform="translate(-0.001 -66)">
          <g id="Group_5" data-name="Group 5">
            <path id="Path_25" data-name="Path 25" d="M0-66,12.881-50.5,0-35.006h8.23L21.111-50.5,8.229-66Z" transform="translate(0.001 66)" fill="#fff" />
          </g>
        </g>
      </g>
    </svg>
