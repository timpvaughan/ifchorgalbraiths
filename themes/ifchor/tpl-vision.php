    ...
    <div class="row align-items-center">
      <div class="col-lg-6">
        <div class="about__content pr-60" data-aos="fade-right">
          ...
          <div class="about__desc text-white"><?php echo wp_kses($image_right_desc, $allowed_html); ?></div>
          <?php endif; ?>
    ...
    <div class="row align-items-center">
      <div class="col-lg-7 offset-lg-6">
        <div class="about__content" data-aos="fade-left">
          ...
          <div class="about__desc text-white"><?php echo wp_kses($image_left_desc, $allowed_html); ?></div>
          <?php endif; ?>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-8">
        <div class="call-to-action__content" data-aos="fade-right">
          <div class="top-arrow-icon">
            <svg id="Group_6051" data-name="Group 6051" xmlns="http://www.w3.org/2000/svg" width="35.479" height="52.087" viewBox="0 0 35.479 52.087">
