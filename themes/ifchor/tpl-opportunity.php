...
$banner_content  = get_field('_opportunity_banner_contents');
...
<?php
$info_contents         = get_field('_opportunity_info_contents');
...
$info_content_two         = get_field('_opportunity_section_two_content');
    ...
    <section class="info-description-two">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="info-description-two__logo">
                        <?php if ($info_content_logo) : ?>
                            <img src="<?php echo esc_url($info_content_logo['url']); ?>" alt="<?php echo esc_attr($info_content_logo['alt']); ?>">
                        <?php endif; ?>
                    </div>

                    <div class="info-description-two__button">
                        <?php if ( ! empty($info_content_button_text)): ?>
                            <a href="<?php echo esc_url($info_content_button_link); ?>" class="ifchor_btn btn-outline">
...
<?php
$about_content             = get_field('_opportunity_solutions_contents');
...
if ($about_btn_link_type == 'internal') {
    $about_btn_url = $about_btn_link;
} else {
    $about_btn_url = $about_btn_link_ext['url'];
}

$target = '';
if ( ! empty($about_btn_link_ext['target'])) {
    $target = 'target="'.$about_btn_link_ext['target'].'"';
}
                ...
                <div class="col-lg-12">
                    <div class="about__content" data-aos="fade-right">
                        ...
                        <?php if ($about_btn_url) : ?>
                            <a href="<?php echo esc_url($about_btn_url); ?>" class="ifchor_btn btn-outline-light about__button" <?php echo $target; ?>>
                                <span class="btn-icon">
...
<?php
$contact_content  = get_field('_opportunity_contact_contents');
...
$button_url = isset($contact_content['button_url']) ? $contact_content['button_url'] : [];
...
<?php
$page_pagination       = get_field('_opportunity_page_pagination_contents');
...
<?php
$blog_content         = get_field('_opportunity_blog_contents');
...
$blog_post_per_page   = isset($blog_content['post_per_page']) ? $blog_content['post_per_page'] : '';
$blog_post_per_column = isset($blog_content['post_per_column']) ? $blog_content['post_per_column'] : '';
