<?php
/**
 * Template Name: Discovery & Execution
 */
get_header();

$banner_content  = get_field('_discovery_banner_contents');
...
<?php
$info_contents         = get_field('_discovery_info_contents');
...
$info_content_two              = get_field('_discovery_section_two_content');
$info_content_title            = isset($info_content_two['title']) ? $info_content_two['title'] : '';
$info_content_description      = isset($info_content_two['description']) ? $info_content_two['description'] : '';
$info_content_logo             = isset($info_content_two['logo']) ? $info_content_two['logo'] : '';
$info_content_button_link_type = isset($info_content_two['button_url_type']) ? $info_content_two['button_url_type'] : '';
$info_content_button_text      = isset($info_content_two['button_text']) ? $info_content_two['button_text'] : '';
$info_content_button_link      = isset($info_content_two['button_url']) ? $info_content_two['button_url'] : '';
$info_content_button_link_ext  = isset($info_content_two['button_url_ext']) ? $info_content_two['button_url_ext'] : '';

$info_btn_link = '';

if ($info_content_button_link_type == 'internal') {
    $info_btn_link = $info_content_button_link;
} else {
    $info_btn_link = $info_content_button_link_ext['url'];
}

$target = '';
if ( ! empty($info_content_button_link_ext['target'])) {
    $target = 'target="'.$info_content_button_link_ext['target'].'"';
}
...
?>
    ...
    <section class="info-description-two">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="info-description-discovery__content" data-aos="fade-up">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30.995" height="21.112" viewBox="0 0 30.995 21.112">
                        ...
                        <?php if ( ! empty($info_content_title)): ?>
                            <h2 class="info-description-two__title"><?php echo wp_kses($info_content_title, $allowed_html); ?></h2>
                        <?php endif; ?>
                    ...
                    <div class="info-description-two__logo" data-aos="fade-up">
                        <?php if ($info_content_logo) : ?>
                            <img src="<?php echo esc_url($info_content_logo['url']); ?>" alt="<?php echo esc_attr($info_content_logo['alt']); ?>">
                        <?php endif; ?>
                    </div>

                    <div class="info-description-two__button" data-aos="fade-up">
                        <?php if ( ! empty($info_content_button_text)): ?>
                            <a href="<?php echo esc_url($info_btn_link); ?>" class="ifchor_btn btn-outline" <?php echo $target; ?>>
                                ...
                                <?php echo wp_kses($info_content_button_text, $allowed_html); ?>
                            </a>
                        <?php endif; ?>
                    </div>
...
<!-- <?php
$about_content             = get_field('_discovery_solutions_contents');
...
$about_btn_link_type       = isset( $about_content['button_url_type'] ) ? $about_content['button_url_type'] : '';
...
if ( $about_btn_link_type == 'internal' ) {
    $ab_btn_url = $about_btn_link;
} else {
    $ab_btn_url = $about_btn_link_ext['url'];
}*/

?>

    <section class="about ig-about bg--secondary">
...
<?php
$contact_content  = get_field('_discovery_contact_contents');
...
if ($contact_button_url_type == 'internal') {
    $con_btn_url = $contact_button_url;
} else {
    $con_btn_url = $contact_button_url_ext['url'];
}
                ...
                <div class="col-lg-6 col-md-7">
                    <div class="contact-section__content" data-aos="fade-right">
                        ...
                        <?php if ( ! empty($contact_button_text)): ?>
                            <a href="<?php echo esc_url($con_btn_url); ?>" class="ifchor_btn btn-outline-light">
...
<?php
$page_pagination       = get_field('_discovery_page_pagination_contents');
...
<?php
$blog_content         = get_field('_discovery_blog_contents');
